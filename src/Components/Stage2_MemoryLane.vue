<template>
  <div
    class="min-h-screen flex flex-col items-center justify-center p-6 bg-gradient-to-b from-[#1a0b2e] to-[#2d1b4e] text-white"
  >
    <!-- Header -->
    <h2
      class="text-3xl font-serif text-purple-200 mb-2 drop-shadow-md animate-fade-in-down"
    >
      Memory Lane ❤️
    </h2>
    ...
    <div class="flex gap-4 mb-8">
      ...
      >
        <div
          class="text-4xl filter drop-shadow-[0_0_10px_rgba(236,72,153,0.8)]"
        >
          {{ q.isUnlocked ? "🔓" : "🔒" }}
        </div>
        <div
    ...
    <Transition name="slide-up" mode="out-in">
      ...
      >
        <!-- Progress Bar -->
        <div
          class="absolute top-0 left-0 h-1 bg-gradient-to-r from-purple-500 to-pink-500 transition-all duration-300"
          :style="{
      ...
      <div v-else class="text-center animate-bounce">
        <h3 class="text-2xl font-bold text-pink-300">
          Semua Gembok Terbuka! 🗝️
        </h3>
